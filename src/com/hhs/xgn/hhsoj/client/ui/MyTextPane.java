...
public class MyTextPane extends JTextPane {
	 ...
	 * 所有关键字
	 */
	private final static String[] _keys = new String[] {"int","float","double","include","long","package","public","private","protected","class","struct","null","void","char","final","const","static","new","this","import","def","print","true","false","extends","interface","implements","using","namespace","new","while","for","do","this","input"};
	/**
	 * 所与排除字符集
	 */
	...
	public MyTextPane() {
		...
		StyleConstants.setFontFamily(keyAttr, "Consolas");
		// 义一般文本显示属性
